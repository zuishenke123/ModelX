...
# Function to generate test cases for AdaptiveMaxPool2d
def generate_test_cases(num_cases=10):
    # Generate multiple test cases, each with its own randomly generated batch of 2-dimensional data This function
    # simulates typical scenarios for AdaptiveMaxPool2d, which is used to output fixed-size tensors by adapting the
    # pooling operation to the input size
    test_cases = []
...
def test_operator(test_cases):
    ...
    # Define an AdaptiveMaxPool2d layer targeting a fixed output size (e.g., 10x10)
    adaptive_pool = nn.AdaptiveMaxPool2d((10, 10))
    ret = []

    print("Testing AdaptiveMaxPool2d on multiple test cases:")
